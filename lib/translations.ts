...
const sr: TranslationTree = {
  ...
  save: "Sačuvaj odgovor",
  choose: "Da li dolazite?",
  chooseHint: "Izaberite opciju pa kliknite na \"Sačuvaj odgovor\" ispod.",
  attending: "Dolazim",
  ...
  ceremony: "Venčanje",
  weddingDetails: "Detalji venčanja",
  rsvpCardTitle: "Potvrda dolaska",
  ...
  saved: "Odgovor je uspešno sačuvan.",
