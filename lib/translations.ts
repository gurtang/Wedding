...
const sr: TranslationTree = {
  ...
  tableNumberTitle: "Broj stola",
  tableNumberPlaceholder: "Ovde ćete moći da vidite vaš broj stola.",
...
const en: TranslationTree = {
  ...
  tableNumberPlaceholder: "Here you will be able to see your table number.",
